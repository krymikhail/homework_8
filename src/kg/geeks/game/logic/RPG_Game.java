...
public class RPG_Game {
    ...
    public static void startGame() {
        ...
        TrickyBastard tricky = new TrickyBastard(200, 10, "Tricky Bastard");
        Deku deku = new Deku(240, 20, "Deku");
        Bomber bomber = new Bomber(220, 15, "Bomber");

        Hero[] heroes = {warrior1, doc, warrior2, magic, berserk, assistant, tricky, deku, bomber};
